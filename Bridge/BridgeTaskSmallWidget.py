...
class TaskSmallWidget(QWidget):
    def __init__(self, task: Task):
        ...
        if self.task.importance_level == ImportanceLevel.INSIGNIFICANT:
            self.importance_label.setText(' 无关紧要')
            self.importance_label.setStyleSheet('background-color:green')
        elif self.task.importance_level == ImportanceLevel.NORMAL:
            self.importance_label.setText('    普通')
            self.importance_label.setStyleSheet('background-color:blue')
        elif self.task.importance_level == ImportanceLevel.NOTE_WORTHY:
            self.importance_label.setText(' 值得关注')
            self.importance_label.setStyleSheet('background-color:yellow')
        elif self.task.importance_level == ImportanceLevel.IMPORTANT:
            self.importance_label.setText('    重要')
            self.importance_label.setStyleSheet('background-color:purple')
        else:
            self.importance_label.setText('    紧急')
            self.importance_label.setStyleSheet('background-color:red')
        ...
        if self.task.tasktype == Task_type.DAILY:
            ...
            self.main_layout.addWidget(self.importance_label, 0, 6, 2, 1)
